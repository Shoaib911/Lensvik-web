...
const NavBar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'>
            <img src={assets.logo} className='w-36 ' alt="Lensvik" />
        </Link>
...
<div className={`fixed top-0 right-0 bottom-0 bg-white transition-all ${visible ? 'w-4/5 sm:w-1/4' : 'w-0'} overflow-hidden shadow-lg`}>
